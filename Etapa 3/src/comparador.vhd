...
begin
    ...
    vaga_disponivel       <= '1' when veiculos_u < capacidade_u else '0';
    estacionamento_lotado <= '1' when veiculos_u >= capacidade_u else '0';
    estacionamento_vazio  <= '1' when veiculos_u = 0 else '0';
